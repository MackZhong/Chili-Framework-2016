...
// https://www.youtube.com/watch?v=KXn7-5zg3J4&index=25&list=PLqCJpWy5Fohfil0gvjzgdV4h29R9kDKtZ
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, LPWSTR pArgs, INT)
{
	try
	{
		...
		try
		{
			std::unique_ptr<Game>  theGame = std::unique_ptr<Game>(new SpriteGame(wnd));
